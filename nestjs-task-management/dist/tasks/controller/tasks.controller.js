...
let TasksController = class TasksController {
    ...
    getTasks(filterDto, user) {
        this.logger.verbose(`User ${user.username} retrieving. Filters: ${JSON.stringify(filterDto)}`);
    ...
    createTask(createTaskDto, user) {
        this.logger.verbose(`User ${user.username} is creating a task. Task: ${JSON.stringify(createTaskDto)}`);
